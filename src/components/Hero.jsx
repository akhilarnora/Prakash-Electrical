...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-[90svh] lg:min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden bg-primary-dark">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full z-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        {/* Left Content Side */}
        <motion.div 
        ...
        >
          ...
          <motion.h1 
            variants={itemVariants}
            className="font-heading font-extrabold text-4xl sm:text-5xl md:text-6xl text-white leading-tight"
          >
          ...
          <motion.p 
            variants={itemVariants}
            className="font-sans text-base sm:text-lg md:text-xl text-accent-light/80 mt-6 max-w-2xl leading-relaxed"
          >
          ...
          <motion.div 
            variants={itemVariants}
            className="grid grid-cols-2 gap-y-3 gap-x-4 sm:flex sm:flex-wrap sm:gap-6 mt-8"
          >
            {[
              ...
              <div key={i} className="flex items-center gap-2 text-accent-light font-medium text-sm sm:text-base">
          ...
          >
            <a
              href={`tel:+91${phone}`}
              className="flex items-center justify-center gap-3 bg-primary-orange hover:bg-accent-gold text-primary-dark font-heading font-bold py-4 px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-primary-orange/30 transform hover:-translate-y-0.5 active:translate-y-0 text-base"
            >
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 bg-accent-dark hover:bg-accent-dark/80 text-white font-heading font-bold py-4 px-8 rounded-xl border border-accent-light/10 hover:border-primary-orange/50 transition-all duration-300 shadow-md transform hover:-translate-y-0.5 active:translate-y-0 text-base"
            >
        ...
        >
          ...
          <div className="w-80 h-96 bg-accent-dark/45 backdrop-blur-md rounded-2xl p-6 border border-accent-light/10 shadow-2xl relative overflow-hidden flex flex-col justify-between">
            {/* Top glowing dot */}
            <div className="absolute -top-12 -right-12 w-28 h-28 rounded-full bg-primary-orange/10 blur-xl" />
            
            {/* Orange bar visual mimicking the card */}
            <div className="absolute top-0 bottom-0 left-0 w-3 bg-primary-orange" />
            
            <div className="pl-4">
              <span className="text-[10px] text-primary-orange font-bold uppercase tracking-widest block mb-2">Licensed Contractor</span>
              <h3 className="font-heading font-bold text-2xl text-white">Binu Prakash</h3>
              <p className="text-xs text-accent-light/60">Owner & Chief Electrician</p>
            </div>

            <div className="pl-4 space-y-3">
              <div className="bg-primary-dark/80 rounded-xl p-3 border border-accent-light/5">
                <span className="text-[10px] text-accent-light/50 block">Direct Hotline</span>
                <span className="font-heading font-bold text-lg text-primary-orange tracking-wide">+91 9847472927</span>
              </div>
              <div className="bg-primary-dark/80 rounded-xl p-3 border border-accent-light/5">
                <span className="text-[10px] text-accent-light/50 block">Locations Covered</span>
                <span className="text-xs text-white font-semibold">Nedumangad, TVM & Suburbs</span>
              </div>
            </div>

            <div className="pl-4 flex items-center gap-3">
              <div className="w-10 h-10 bg-primary-orange/10 rounded-lg flex items-center justify-center text-primary-orange">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <div>
                <span className="text-xs text-white font-bold block">100% Safe Wiring</span>
                <span className="text-[10px] text-accent-light/60">Standards Compliant</span>
              </div>
            </div>
          </div>
        </motion.div>
